            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                        <h2>Flight Number: <?= h($hotels->name) ?></h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="../../webroot/css/customerSide/img/ind/industries_<?= h($hotels->id) ?>.png" alt="">
                        <div class="hotel_text_iner">
                            <h3>Details: </a></h3>
                            <p>Location: <?= $hotels->location?></p>
                            <p>Telephone Number:  <?= $hotels->telephone?></p>
                            <h5>Total Cost: <span><?= $hotels->price === null ? '' : $this->Number->format($hotels->price) ?></span></h5>
                        </div>
                    </div>
                </div>
            </div>
