...
<main class="main">
    <section class="top_place section_padding">
        <div class="container">
            ...
            <div class="row">
                <?php foreach ($insurance as $index => $insurance) {?>
                    <div class="col-lg-6 col-md-6">
                        <div class="single_place">
                            <img src="../webroot/css/customerSide/img/ind/industries_<?= $index + 1?>.png" alt="">
                            <div class="hover_Text d-flex align-items-end justify-content-between">
                                <div class="hover_text_iner">
                                    <h3><?= $insurance->Supplier ?></h3>
                                    <p>Level:  <?= $insurance->level?> </p>
                                    <p>Description: <?= $insurance->description?></p>
                                    <p>Total Price: <?= $insurance->price?></p>
                                    <a href=<?= $this->Url->build(['controller' => 'Hotels', 'action' => 'customerSideView', $insurance->id])?>>View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
