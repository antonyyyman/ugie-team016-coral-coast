...
<main class="main">
    <section class="top_place section_padding">
        <div class="container">
            ...
            <div class="row">
                <?php foreach ($translations as $index => $translations) {?>
                        ...
                        <div class="single_place">
                            ...
                            <div class="hover_Text d-flex align-items-end justify-content-between">
                                <div class="hover_text_iner">
                                    ...
                                    <p>Total Price: <?= $translations->price?></p>
                                    <a href=<?= $this->Url->build(['controller' => 'Translations', 'action' => 'customerSideView', $translations->id])?>>View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
