            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                        <h2>Flight Number: <?= h($flights->number) ?></h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="../../webroot/css/customerSide/img/single_place_<?=h($flights->id)?>.png" alt="">
                        <div class="hotel_text_iner">
                            <h3>Details: </a></h3>
                            <p>Departure Airport:  <?= $flights->departure_airport?></p>
                            <p>Arrival Airport: <?= $flights->arrival_airport?></p>
                            <p>Departure Date:  <?= $flights->departure_date?></p>
                            <p>Arrival Date: <?= $flights->arrival_date?></p>
                            <p>Total Price: <?= $flights->price?></p>
                            <h5>Total Cost: <span><?= $flights->price === null ? '' : $this->Number->format($flights->price) ?></span></h5>
                        </div>
                    </div>
                </div>
            </div>
