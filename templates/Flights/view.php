...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?php if($is_staff){
                echo $this->Html->link(__('Edit Flight'), ['action' => 'edit', $flight->id], ['class' => 'side-nav-item']);
                echo $this->Form->postLink(__('Delete Flight'), ['action' => 'delete', $flight->id], ['confirm' => __('Are you sure you want to delete # {0}?', $flight->id), 'class' => 'side-nav-item']);
                echo $this->Html->link(__('New Flight'), ['action' => 'add'], ['class' => 'side-nav-item']);
            }?>
