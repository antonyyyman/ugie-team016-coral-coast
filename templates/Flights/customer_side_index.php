 ...
 * @var iterable<\App\Model\Entity\Flights> $flights
 */
?>
                        ...
                        <div class="single_place">
                            ...
                            <div class="hover_Text d-flex align-items-end justify-content-between">
                                <div class="hover_text_iner">
                                    ...
                                    <a href=<?= $this->Url->build(['controller' => 'Flights', 'action' => 'customerSideView', $flights->id])?>>View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
