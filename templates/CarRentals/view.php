...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?php if($is_staff){
                echo $this->Html->link(__('Edit Car Rental'), ['action' => 'edit', $carRental->id], ['class' => 'side-nav-item']);
                echo $this->Form->postLink(__('Delete Car Rental'), ['action' => 'delete', $carRental->id], ['confirm' => __('Are you sure you want to delete # {0}?', $carRental->id), 'class' => 'side-nav-item']);
                echo $this->Html->link(__('New Car Rental'), ['action' => 'add'], ['class' => 'side-nav-item']);
            }?>
            <?= $this->Html->link(__('View All Rentals'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
