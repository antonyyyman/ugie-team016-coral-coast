            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                        <h2>Car Rentals</h2>
                        <p>Here are some Car rental services that might suit you!</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <?php foreach ($carRentals as $index => $carRental) {?>
                    <div class="col-lg-6 col-md-6">
                        <div class="single_place">
                            <img src="../webroot/css/customerSide/img/single_place_<?= $index + 1?>.png" alt="">
                            <div class="hover_Text d-flex align-items-end justify-content-between">
                                <div class="hover_text_iner">
                                    <h3><?= $carRental->description?></h3>
                                    <p>Company:  <?= $carRental->company?></p>
                                    <p>License Plate: <?= $carRental->plate?></p>
                                    <p>Total Price: <?= $carRental->price?></p>
                                    <a href=<?= $this->Url->build(['controller' => 'CarRentals', 'action' => 'customerSideView', $carRental->id])?>>View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
