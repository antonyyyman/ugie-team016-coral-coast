            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                        <h2><?= h($cruises->company) ?> Cruises</h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="../../webroot/css/customerSide/img/single_place_<?=h($cruises->id)?>.png" alt="">
                        <div class="hotel_text_iner">
                            <h3>Details: </a></h3>
                            <p>Company: <?= $cruises->company?></p>
                            <p>Description: <?= $cruises->decription?></p>
                            <h5>Total Cost: <span><?= $cruises->price === null ? '' : $this->Number->format($cruises->price) ?></span></h5>
                        </div>
                    </div>
                </div>
            </div>
