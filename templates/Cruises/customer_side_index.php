            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                        <h2>Cruises</h2>
                        <p>Top up your holiday with a relaxing Cruise</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <?php foreach ($cruises as $index => $cruises) {?>
                    <div class="col-lg-6 col-md-6">
                        <div class="single_place">
                            <img src="../webroot/css/customerSide/img/single_place_<?= $index + 1?>.png" alt="">
                            <div class="hover_Text d-flex align-items-end justify-content-between">
                                <div class="hover_text_iner">
                                    <h3><?= $cruises->description?></h3>
                                    <p>Company:  <?= $cruises->company?></p>
                                    <p>Total Price: <?= $cruises->price?></p>
                                    <a href=<?= $this->Url->build(['controller' => 'Cruises', 'action' => 'customerSideView', $cruises->id])?>>View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
